...
### 1. Interactive Virtual Control Surface
* **Real-time Sync:** Drag custom-rendered knobs with sub-millisecond latency. Twist a knob on the screen, and the physical amp updates instantly—and vice versa!
...
### 3. Run It Anywhere & Offline (WebHID & PWA!)
...
### 5. Advanced MIDI Control (MIDX-20 Spec)
...
2. Open a Chromium browser (Chrome, Edge, Opera, Vivaldi) and navigate to the Mustang Amp Control web app.
